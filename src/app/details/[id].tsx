...
// DATABASE
import { useTransactionDatabase } from "@/database/useTransitionDatabase";
import { useGoalDatabase } from "@/database/useGoalDatabase";
...
export default function Details() {
  ...
  // DATABASE
  const { create, findByGoal } = useTransactionDatabase();
  const { show } = useGoalDatabase();
